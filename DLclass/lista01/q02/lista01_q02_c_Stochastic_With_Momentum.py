...
num_epochs = 10000
alfa = 0.1
(w2, epstop, verrom) = training_net_delta_mom(net_arc, net_func, w, b, X, target, learn_rate, alfa, num_epochs)

forward(net_arc, net_func, w1, b, X[0])


[ti, to, vi, vo, tei, teo] = dataset_generator(10, 4, 4)
g = np.arange(-5., 5., 0.2)
visualizeActivationFunc('step', g)
visualizeActivationFunc('ptanh', g)

visualizeDerivActivationFunc('step', g)
visualizeDerivActivationFunc('sigm', g)
