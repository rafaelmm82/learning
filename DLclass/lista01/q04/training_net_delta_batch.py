# -*- coding: utf-8 -*-
"""
First assignment - ann training net, delta rule with batch
Class Deep Learning
UFPB
...
# -----------------------------------
# Training Function Stochastic with Batch blocs
# (shuffling all dataset on each epoch)
# -----------------------------------
def training_net_delta_batch(net_arc, net_func, w, b, data_in, target,
                             learn_rate, num_epochs, batchsize=0,
                             err_max=0.0001):
    """
